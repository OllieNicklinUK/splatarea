    ...
    <div class="ticker-card">
      <header class="ticker-header">
        <div class="ticker-title">
          ...
          <span>${escHtml(window.__APP_CONFIG__?.appName || 'Market Ticker')}</span>
        </div>
          ...
          <div class="price-list">
            ${prices.map((p) => `
              <div class="price-row">
                ...
                <div class="price-value">${formatPrice(p.price, TICKER_CONFIG.currency)}</div>
                <div class="price-change price-change--${p.changeDir}">
